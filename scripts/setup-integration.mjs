...
const REAL_PACKAGES = {
  ...
  '@peroxider/dsh-python-bridge-runtime': `${root}/packages/bridge/python-bridge-runtime/src/index.ts`,
  '@peroxider/dsh-python-bridge': `${root}/packages/bridge/python-bridge/src/index.ts`,
}
