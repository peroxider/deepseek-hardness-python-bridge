/**
 * Package-owned invariant companion for `@peroxider/dsh-python-bridge-runtime`.
 * @module @peroxider/dsh-python-bridge-runtime/invariant
 */
...
const PACKAGE_NAME = '@peroxider/dsh-python-bridge-runtime'
