/**
 * Vitest coverage for `@peroxider/dsh-python-bridge-codegen`.
 *
...
describe('generateBridgePackage (service-class form)', () => {
  ...
  it('imports every runtime dependency the emitted code uses', () => {
    ...
    expect(index.contents).toContain(`from '@peroxider/dsh-python-bridge-runtime'`)
    expect(pkg.dependencies['@peroxider/dsh-python-bridge-runtime']).toBeDefined()
