/**
 * Package-owned invariant companion for `@peroxider/dsh-python-bridge-codegen`.
 * @module @peroxider/dsh-python-bridge-codegen/invariant
 */
...
const PACKAGE_NAME = '@peroxider/dsh-python-bridge-codegen'
