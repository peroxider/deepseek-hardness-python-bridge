...
Read `references/decorators.md` for the full decorator contract. The `initialize` manifest schema the runtime reports (services, methods, tools, listeners) lives in `references/manifest.md`.
